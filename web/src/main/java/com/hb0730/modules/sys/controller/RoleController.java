...
public class RoleController {
    ...
    public R<String> updateById(@RequestBody RoleDto roleDto) {
        ...
        String username = SecurityUtil.getUsername();
        roleDto.setModifiedBy(username);
    ...
    public R<String> deleteById(@RequestParam(name = "id") Long id) {
    ...
    public R<String> assignPermission(@RequestParam(name = "roleId") Long roleId,
