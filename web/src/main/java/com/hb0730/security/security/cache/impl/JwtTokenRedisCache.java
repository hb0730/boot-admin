package com.hb0730.security.security.cache.impl;
...
import com.hb0730.security.util.JwtUtil;
...
public class JwtTokenRedisCache implements TokenProvider {
    ...
    public String createAccessToken(UserInfoDto dto) {
        String token = JwtUtil.sign(dto.getUsername(), properties.getJwtSecret(), dto.getSysCode());
