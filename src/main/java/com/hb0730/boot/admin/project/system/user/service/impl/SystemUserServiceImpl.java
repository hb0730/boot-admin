 ...
 */
@Service
public class SystemUserServiceImpl extends SuperBaseServiceImpl<Long, UserParams, SystemUserVO, SystemUserMapper, SystemUserEntity> implements ISystemUserService {
    @Autowired
