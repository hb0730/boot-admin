 ...
 */
@Service
public class SystemJobLogServiceImpl extends SuperBaseServiceImpl<Long, JobLogParams, SystemJobLogVO, ISystemJobLogMapper, SystemJobLogEntity> implements ISystemJobLogService {
    @Autowired
