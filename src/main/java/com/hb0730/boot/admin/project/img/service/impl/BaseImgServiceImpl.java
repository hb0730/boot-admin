...
import com.hb0730.boot.admin.utils.file.FileUtils;
...
@Service
@AllArgsConstructor
public class BaseImgServiceImpl extends SuperBaseServiceImpl<Long, BaseImgParams, BaseImgVO, IBaseImgMapper, BaseImgEntity> implements IBaseImgService {
