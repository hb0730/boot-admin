...
public class ImgGenerator {
    public static void main(String[] args) {
        ...
        strategyConfig.setInclude("t_base_img");
        ...
        strategyConfig.setSuperServiceImplClass(MysqlProperties.SUPER_SERVICE_IMPL_CLASS);
        ...
        packageConfig.setModuleName("img");
