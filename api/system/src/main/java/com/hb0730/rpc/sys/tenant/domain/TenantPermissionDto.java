...
public class TenantPermissionDto extends DomainDto implements TreeUtil.Node<TenantPermissionDto, Long> {
    ...
    private List<TenantPermissionDto> children;

    @Override
    public void setChildren(List<TenantPermissionDto> children) {
        this.children = children;
    }

    @Override
    public List<TenantPermissionDto> getChildren() {
        return children;
    }
